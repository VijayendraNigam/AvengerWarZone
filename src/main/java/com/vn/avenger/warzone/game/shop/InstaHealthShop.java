...
public class InstaHealthShop {

	private InstaHealthShop() {
	...
	public static void shop(Hero hero) {
		...
		while (true) {
			...
			Gui.out.println(SCREEN_FACTORY.get(SCREENS.TYPES.INSTA_HEALTH_SHOP));
			...
			case 1:
			case 2:
				InstaHealthPO instaHealth = INSTA_HEALTH_FACTORY.get(INSTA_HEALTH.TYPES.values()[choice - 1]);
				MessageCodes code = hero.buy(instaHealth);
