...
public class LokiCombatantStats implements IoC<CombatantStats> {

	@Override
	public CombatantStats inject() {
		return new CombatantStats().setGeneral(new GeneralVO().setCombatantName(MONSTER.LOKI.getMonsterName()));
	}
