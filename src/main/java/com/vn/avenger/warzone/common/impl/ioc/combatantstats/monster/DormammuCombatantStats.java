...
public class DormammuCombatantStats implements IoC<CombatantStats> {

	@Override
	public CombatantStats inject() {
		return new CombatantStats()
				.setGeneral(new GeneralVO().setCombatantName(MONSTER.DORMAMMU.getMonsterName()))
				.setEquipped(new EquippedVO().setAcquiredArsenal(ARSENAL_FACTORY.get(ARSENAL.TYPES.PISTOL)));
	}
