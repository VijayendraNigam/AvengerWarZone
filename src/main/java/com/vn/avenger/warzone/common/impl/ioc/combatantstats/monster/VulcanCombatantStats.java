...
public class VulcanCombatantStats implements IoC<CombatantStats> {

	@Override
	public CombatantStats inject() {
		return new CombatantStats().setGeneral(new GeneralVO().setCombatantName(MONSTER.VULCAN.getMonsterName()));
	}
