...
public class InstaHealthShopScreen implements Window<String> {
	...
	public String view() {
		...
		screen.append("|           +-+-+-+-+-+-+-+  +-+-+-+-+-+-+-+           |").append(NEWLINE);
		screen.append("|                                                      |").append(NEWLINE);
		screen.append("|                   InstaHealth Shop                   |").append(NEWLINE);
		screen.append("|                                                      |").append(NEWLINE);
		screen.append("|^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^|").append(NEWLINE);
		screen.append("|                                                      |").append(NEWLINE);
		screen.append("|       Which insta health would you like to buy ?     |").append(NEWLINE);
		screen.append("|                                                      |").append(NEWLINE);
